export const isSuitableForRunning = (weatherData: {
  ...
  details.push({
    condition: `온도: ${temp}°C`,
    rating:
        temp < 0 || temp > 30 ? "danger" : temp >= 10 && temp <= 20 ? "good" : "warning",
  ...
  details.push({
    ...
    rating: humidity < 20 || humidity > 80 ? "danger" : humidity <= 70 ? "good" : "warning",
  ...
  details.push({
    ...
    rating: visibilityInKm < 0.5 ? "danger" : visibilityInKm >= 1 ? "good" : "warning",
